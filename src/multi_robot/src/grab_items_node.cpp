...
class GrabItems : public plansys2::ActionExecutorClient
{
public:
  GrabItems()
  : plansys2::ActionExecutorClient("grab_items", 1s)
  {
    progress_ = 0.0;
  }
...
private:
  void do_work()
  {
    if (progress_ < 1.0) {
      ...
      finish(true, 1.0, "Grab items completed");
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<GrabItems>();
